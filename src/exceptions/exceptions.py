...
daily_schedule_not_found = create_not_found_exception("DailySchedule")
weekly_schedule_not_found = create_not_found_exception("WeeklySchedule")
grade_not_found = create_not_found_exception("Grade")